...
#if defined(SPARC)
#include "../defns/sparc_defns.h"
#elif defined(INTEL)
#include "../defns/intel_defns.h"
#elif defined(PPC)
#include "../defns/ppc_defns.h"
#elif defined(IA64)
#include "../defns/ia64_defns.h"
#elif defined(MIPS)
#include "../defns/mips_defns.h"
#elif defined(ALPHA)
#include "../defns/alpha_defns.h"
#else
 ...
 * don't cause contention on thread-local or read-only fields. CACHE-LINE 对齐 */
...
/* POINTER MARKING */
#define get_all_unmarked_ref(_p)       ((void *)(((unsigned long)(_p)) & ~7))
#define get_marked_ref(_p)             ((void *)(((unsigned long)(_p)) | 1))
#define is_marked_ref(_p)              (((unsigned long)(_p)) & 1)
#define get_unpersisted_next_ref(_p)   ((void *)(((unsigned long)(_p)) | 3))
#define get_persisted_next_ref(_p)     ((void *)(((unsigned long)(_p)) & ~2))
#define is_unpersisted_next_ref(_p)    (((unsigned long)(_p)) & 2)
#define get_unpersisted_pre_ref(_p)    ((void *)(((unsigned long)(_p)) | 4))
#define get_persisted_pre_ref(_p)      ((void *)(((unsigned long)(_p)) & ~4))
#define is_unpersisted_pre_ref(_p)     (((unsigned long)(_p)) & 4)


/* SUPPORT FOR WEAK ORDERING OF MEMORY ACCESSES X86_64是强内存顺序 */
